  ...
  return (
    <section className="overflow-hidden rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h2 className="font-semibold text-zinc-950">Catalog rail</h2>
        ...
        {catalogItems.map((item) => {
          ...
          return (
            <motion.a
              ...
              className="group relative min-h-56 w-[18rem] shrink-0 snap-start overflow-hidden rounded-lg border border-zinc-200 bg-zinc-950 p-5 text-white shadow-sm sm:w-[22rem]"
            >
              ...
              <div className="relative flex h-full flex-col justify-between">
                <div className="grid size-11 place-items-center rounded-full bg-white/20 backdrop-blur-md">
