  ...
  return (
    <RequireAuth>
      <div className="min-h-screen bg-[radial-gradient(circle_at_12%_10%,rgba(20,184,166,0.18),transparent_28rem),radial-gradient(circle_at_84%_16%,rgba(14,165,233,0.16),transparent_30rem),linear-gradient(135deg,#f8fafc,#eef5f5_48%,#f8fafc)]">
        <div className="flex min-h-screen items-start gap-3 p-3 md:p-4">
          <AppSidebar />
          <div className="min-h-[calc(100vh-2rem)] min-w-0 flex-1 overflow-hidden rounded-[2rem] border border-white/70 bg-white/90 shadow-[0_28px_90px_rgba(15,23,42,0.12)] backdrop-blur">
            ...
            <main className="min-h-[calc(100vh-6rem)] overflow-auto">
              <Outlet />
            </main>
          </div>
        </div>
